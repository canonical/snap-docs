...
The state of snapd, and many of its key functions, can be accessed through its {ref}`REST API <reference-development-snapd-rest-api>`, enabling remote device configuration, updates and orchestration.
