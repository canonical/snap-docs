...
1. {ref}`system.kernel.cmdline-append <reference-administration-system-options-kernel-cmdline-append>`
2. {ref}`system.kernel.dangerous-cmdline-append <reference-administration-system-options-kernel-dangerous-cmdline-append>`
