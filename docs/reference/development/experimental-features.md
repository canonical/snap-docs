...
| [refresh-app-awareness-ux](https://github.com/canonical/snapd/pull/13479)         | Apr 2024 (snapd 2.62)   | YES                 | There are some bugs that need to be addressed and some work on the desktop side.             |
