...
| {ref}`Confdb <explanation-how-snaps-work-confdb-configuration-mechanism>`          | Jan 2024 (snapd 2.62)   | NO                 | Configuration via confdb views.                                                              |
...
| confdb-control                                                                     | Feb 2025 (snapd 2.68)   | NO                 | Delegate control of confdb views to operators. Full end-to-end use requires remote-device-management, which is still under development. |
| content-compatibility-label                                                        | Sep 2025 (snapd 2.72)   | NO                 |                                                                                              |
| clustering                                                                         | Oct 2025 (snapd 2.73)   | NO                 |                                                                                              |
| remote-device-management                                                           | Jan 2026 (snapd 2.74.1) | NO                 | Remote device management via the Store. Currently under active development.                  |
| seed-refresh                                                                       | Feb 2026 (snapd 2.74.1) | NO                 |                                                                                              |
| snap-delta-format                                                                  | Feb 2026 (snapd 2.74.1) | NO                 |                                                                                              |
