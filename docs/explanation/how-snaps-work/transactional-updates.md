...
A transactional update or installation can be instantiated from either the **snap** command, or from the {ref}`SnapD REST API <reference-development-snapd-rest-api>`.
