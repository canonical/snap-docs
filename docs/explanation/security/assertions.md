...
[Snapcraft](https://documentation.ubuntu.com/snapcraft/stable/), {ref}`snapd <ref-glossary_snapd>`, the [Snap Store](https://snapcraft.io/store) and [Brand stores](https://ubuntu.com/core/docs/brand-stores) all use assertions to handle a variety of functions and processes, including authentication, policy setting, identification and validation.
