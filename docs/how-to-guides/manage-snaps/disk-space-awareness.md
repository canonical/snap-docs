...
The [REST API](api/redoc-static.html) will also return an `insufficient-disk-space` [error response](/reference/development/error-responses) object when disk space awareness is enabled and an error is encountered.
