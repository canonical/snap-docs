...
See below for details on accessing the API,  authentication, JSON elements and error types, and see the {ref}`API reference <reference-development-snapd-rest-api>` for which actions can be performed and which elements can be requested.
